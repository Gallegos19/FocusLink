package com.example.focuslink.core.FCM
...
class FCMService:FirebaseMessagingService() {
    ...
    private fun showNotification(title: String, body: String, data: Map<String, String>) {
        ...
        val bigPictureStyle = NotificationCompat.BigPictureStyle()
            .bigPicture(BitmapFactory.decodeResource(resources, R.drawable.focuslinklogo)) // o una imagen de URL con Glide

        val notification = NotificationCompat.Builder(this, MyApp.NOTIFICATION_CHANNEL_ID)
            .setContentTitle(title)
            .setContentText(body)
            .setSmallIcon(R.drawable.focuslinklogo)
